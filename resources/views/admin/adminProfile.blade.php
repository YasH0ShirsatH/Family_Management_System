                        ...
                        <div class="card-body p-4">
                            <form id="formSubmit" method="post">
                                ...
                                <div class="mb-3 form-group">
                                    <label for="active-member" class="form-label fw-semibold">Select Head to Activate</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="activation_mode" id="activateAll" value="all" checked>
                                        <label class="form-check-label" for="activateAll">
                                            Activate Head and All Members
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="activation_mode" id="activateSelected" value="selected">
