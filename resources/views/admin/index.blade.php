                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title text-success">
                                <i class="bi bi-people me-2"></i>{{ $heads->sum(function($head) { return $head->members->count(); }) }}
                            </h5>
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-header bg-primary text-white text-center">
                                    <h6 class="mb-0">
                                        <i class="bi bi-person-badge me-2"></i>{{ $user->name }} Family
                                    </h6>
                                </div>
                                ...
                                <div class="card-body text-center p-4">
                                    ...
                                    <h6 class="fw-bold mb-3">{{ $user->name }} {{ $user->surname }}</h6>
                                ...
                                <div class="card-footer bg-light">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <a href="{{ route('admin-member.show',$user->id)}}" class="btn btn-outline-danger btn-sm">
