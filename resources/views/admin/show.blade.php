                        ...
                        <div class="info-grid">
                            <div class="info-card">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value">{{ date('M d, Y', strtotime($heads->mariage_date)) }}</span>
                                </div>
                                @endif
                            </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="member-card">
                                            @if(empty($member->photo_path))
                                                <img src="{{ asset('uploads/images/noimage.png') }}" class="member-img" alt="No Image">
                                            @else
                                                <img src="{{ asset('uploads/images/' . $member->photo_path) }}" class="member-img" alt="Member Photo">
                                            @endif
