                ...
                <div class="col-lg-10">
                    <div class="card shadow-sm border-0 mb-4 rounded-4">
                        ...
                        <div class="card-body p-5 text-center">
                                    ...
                                    <div class="card bg-light border-0 h-100 rounded-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="list-group list-group-flush">
                                                <div
                                                    class="list-group-item bg-transparent d-flex justify-content-between px-0 py-2">
                                                    <span class="text-muted">
                                                        <i class="bi bi-calendar3 text-primary me-2"></i>Date of Birth
                                                    </span>
                                                    <span
                                                        class="fw-semibold">{{ date('M d, Y', strtotime($heads->birthdate)) }}</span>
                                                </div>
                                                <div
                                                    class="list-group-item bg-transparent d-flex justify-content-between px-0 py-2">
                                                    <span class="text-muted">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <p class="mb-0 fw-semibold">
                                        @foreach ($heads->hobbies as $hobby)
                                            <span
                                                class="badge bg-secondary me-2 mb-2">{{ ucfirst($hobby->hobby_name) }}</span>
                                        @endforeach
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                <a href="{{ route('download', $heads->id) }}" class="btn btn-outline-danger px-4 w-40"
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-4">
                                            <div class="card border-0 shadow-sm h-100 rounded-4">
                                                @if(empty($member->photo_path))
                                                    <img src="{{ asset('uploads/images/noimage.png') }}" class="card-img-top"
