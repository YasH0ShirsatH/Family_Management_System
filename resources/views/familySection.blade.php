...
<head>
    ...
    <style>
        ...
        .card-header-custom h2, .card-header-custom h3 {
            font-size: 1.5rem;
            font-weight: 600;
            margin: 0;
            display: flex;
...
<body>
                    ...
                    <div class="card-body-custom">
                        <form action="{{ route('addMember',$id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="education" class="form-control" placeholder="Enter education qualification"
                                    value="{{ old('education') }}">
                                @error('education')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                ...
                <div class="main-card">
                    ...
                    <div class="card-body-custom text-center">
                        <img src="{{ asset('uploads/images/' . $users->photo_path) }}"
                            class="profile-image mb-4" alt="Head Photo">
                        
                        <h4 class="mb-4" style="color: var(--dark-text);">{{ ucfirst($users->name) }} {{ ucfirst($users->surname) }}</h4>
                                ...
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        @if(empty($member->photo_path))
                                            <img src="{{ asset('uploads/images/noimage.png') }}" class="member-img h-100" alt="No Image">
                                        @else
                                            <img src="{{ asset('uploads/images/' . $member->photo_path) }}" class="member-img h-100" alt="Member Photo">
                                        @endif
                                    </div>
                                    <div class="col-md-8">
                                        <div class="p-4">
                                            <h4 class="mb-3" style="color: var(--dark-text); font-weight: 600;">{{ $member->name }}</h4>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="text-center p-3 bg-light rounded">
                                                        ...
                                                        <strong class="small">{{ date('M d, Y', strtotime($member->birthdate)) }}</strong>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="text-center p-3 bg-light rounded">
                                                        ...
                                                        <strong class="small">{{ $member->marital_status ? 'Married' : 'Single' }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="text-center p-3 bg-light rounded">
                                                        ...
                                                        <strong class="small">{{ date('M d, Y', strtotime($member->mariage_date)) }}</strong>
                                                    </div>
                                                </div>
                                                @endif
                                                <div class="col-sm-6 col-lg-3">
                                                    <div class="text-center p-3 bg-light rounded">
                                                        ...
                                                        <strong class="small">{{ $member->education ?: 'Not Provided' }}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        logoutButton.addEventListener('click', function(event) {
            if (!confirm('Are you sure you want to complete the registration? Make sure you have added all family members.')) {
