...
<body class="bg-light">
    <div class="container py-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="card shadow rounded-4 sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body p-4">
                        <form id="formSubmit" action="{{ route('addMember', $id) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 form-group">
                                <input type="text" name="name" class="form-control rounded-pill" placeholder="Full Name"
                                    value="{{ old('name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-3 form-group " id="mrg_date_div"
                                    ...
                                    <input type="date" name="mariage_date" class="form-control rounded-pill"
                                        placeholder="Marriage Date" value="{{ old('mariage_date') }}">
                                    <div class="validation-error"></div>
                            ...
                            <div class="mb-3 form-group">
                                <input type="text" name="education" class="form-control rounded-pill"
            ...
            <div class="col-lg-7">
                <div class="card shadow rounded-4">
                    <div class="card-header bg-primary text-white py-3 rounded-top-4">
                        <h5 class="mb-0 fw-bold"><i class="bi bi-people me-2"></i>Family Members
                            ({{ $members->count() + 1 }})</h5>
                    </div>
                        ...
                        <div class="p-4 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <small
                                        class="text-muted d-block">{{ date('M d, Y', strtotime($users->birthdate)) }}</small>
                                    <small class="text-muted">{{ $users->marital_status ? 'Married' : 'Single' }} •
                                        {{ $users->city }}, {{ $users->state }}</small>
                                </div>
                            </div>
                        </div>
            ...
            <a href="{{ route('logoutMember', $id) }}" class="btn btn-success rounded-pill  mx-auto mt-5 p-3" id="logout" style="width : 20%">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            logoutButton.addEventListener('click', function (event) {
                if (!confirm('Complete registration and submit?')) {
