                        ...
                        <form action="head" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-3" id="mrg_date_div"
                                    ...
                                    <label class="form-label" for="mariage_date"><i class="bi bi-calendar-heart"></i> Marriage Date</label>
                            ...
                            <div class="hobby-section mb-4">
                                ...
                                <input type="text" name="hobbies[]" class="form-control mb-3" placeholder="Enter hobby or interest">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="bi bi-check-circle me-2"></i>Register Family Head
                                </button>
                            </div>
                        </form>
                    </div>
