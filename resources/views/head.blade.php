                        ...
                        <form action="head" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control rounded-pill" placeholder="Enter first name" value="{{ old('name') }}">
                                    @error('name')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-semibold">Last Name</label>
                                    <input type="text" name="surname" class="form-control rounded-pill" placeholder="Enter last name" value="{{ old('surname') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" name="mobile" class="form-control rounded-pill" placeholder="Enter mobile number" value="{{ old('mobile') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" class="form-control rounded-4" rows="3" placeholder="Enter complete address">{{ old('address') }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="pincode" class="form-control rounded-pill" placeholder="Enter pincode" value="{{ old('pincode') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-3" id="mrg_date_div" style="display: {{ old('marital_status') == '1' ? 'block' : 'none' }}">
                                    ...
                                    <input type="date" name="mariage_date" id="mariage_date" class="form-control rounded-pill" value="{{ old('mariage_date') }}">
                            ...
                            <div class="card bg-light mb-4 rounded-4">
                                <div class="card-body">
                                    ...
                                    <div id="hobbyContainer">
                                        <input type="text" name="hobbies[]" class="form-control rounded-pill mb-2" placeholder="Enter hobby">
                                    </div>
